...
public class ImageCompressUtil {
	...
	private static ImageCompressUtil imageHelper = null;

    public static ImageCompressUtil getImageHelper() {
        if (imageHelper == null) {
            imageHelper = new ImageCompressUtil();
        }
        return imageHelper;
    }
     ...
     * @param format          格式
     */
    public static void ByteToScaleImage(byte[] data,String destinationPath, double scale, String format) {
    ...
    /**
     * @param sourceDouble
     * @return 将double类型的数据转换为int，四舍五入原则
     */
    ...
    public static double getDot2Decimal(int a, int b) {
        ...
        Double double1 = Double.valueOf(bigDecimal_result.toString());
        return double1;
    }
