...
import com.ltw.netty.standard.ServerEndpointConfig;
...
public class PojoEndpointServer {
    ...
    public static final AttributeKey<SocketSession> SESSION_KEY = AttributeKey.valueOf("WEBSOCKET_SESSION");
    ...
    public void doBeforeHandshake(Channel channel, FullHttpRequest req, String path) {
        ...
        SocketSession socketSession = new SocketSession(channel);
        channel.attr(SESSION_KEY).set(socketSession);
